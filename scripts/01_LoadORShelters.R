...
sh23 <- read_csv("../fieldmark-faims/data/FAIMS2023/SheltersCleanedOR20231117.csv")  # 166 records

# Grab OR data where occlusive annotations have been separated from data
sh23 <- read_csv("../fieldmark-faims/data/FAIMS2023/SheltersCleanedOR20231117.csv")
